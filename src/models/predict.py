...
from src.models.train_text_model import predict_tfidf_logreg, predict_distilbert
...
def detect_text_model_type(save_dir="models/text_only"):
    """Detect whether saved text model is TF-IDF or DistilBERT."""
    if os.path.exists(os.path.join(save_dir, "logreg_model.joblib")):
        return "tfidf"
