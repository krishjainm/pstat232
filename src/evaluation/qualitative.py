...
ERROR_CATEGORIES = {
    "sarcasm_irony": [
        ...
        r"(?i)(?:sure|right).*(?:if you|when it|after it)",
        r"(?i)(?:just kidding|NOT|can'?t believe).*(?:bad|broke|fail|terrible|worst)",
    ],
    "mixed_sentiment": [
        r"(?i)(?:good|great|nice|love|like|enjoy).*(?:but|however|although|except|unfortunately|only|downside|issue|problem)",
        r"(?i)(?:but|however|although|except|unfortunately).*(?:good|great|nice|love|like|enjoy)",
        r"(?i)\b(?:pro|pros)\b.*\b(?:con|cons)\b",
        r"(?i)(?:works? (?:well|great|fine)).*(?:but|however|except|only|downside)",
        r"(?i)(?:not bad|pretty good).*(?:but|however|could|wish|hoped)",
        r"(?i)(?:overall|mostly|generally).*(?:but|however|except|issue|problem)",
    ],
    "rating_misuse": [
    ...
    "comparative": [
        ...
        r"(?i)(?:compared to|in comparison|vs\.?|versus)",
        r"(?i)(?:prefer|preferred|switch|switched) (?:to|from|the|this|that)",
        r"(?i)not as (?:good|bad|nice|effective) as",
    ],
    "conditional_sentiment": [
        r"(?i)(?:if you|depends? on|for the price|for what)",
        r"(?i)(?:good for|great for|works? for|perfect for).*(?:but|not for|unless)",
        r"(?i)(?:would be|could be) (?:better|great|good) (?:if|with|without)",
        r"(?i)(?:you get what you pay for|at this price point)",
    ],
    "topic_drift": [
        r"(?i)(?:amazon|prime|subscribe|subscription|delivery|arrived|box|packaging)",
        r"(?i)(?:gift|birthday|christmas|anniversary|wedding)(?!.*(?:bad|terrible|worst|broke))",
        r"(?i)(?:my (?:wife|husband|daughter|son|mom|dad|friend|sister|brother))",
    ],
    "ambiguous": [
        r"(?i)^(?:ok|okay|fine|decent|average|alright|meh|so-so|not bad)[\.\,\!\s]*$",
        r"(?i)(?:it'?s? (?:ok|okay|fine|alright|decent))",
        r"(?i)^(?:good|nice|works)[\.\!\s]*$",
    ],
    "short_review": [],
}
